...
from src.dashboard.plotting.discharge import add_discharge_traces, add_inference_traces
from src.dashboard.plotting.precipitation import add_precip_obs_traces, add_precip_pred_traces
