...
from src.database.models import Discharge, Inference
from src.database.queries import (
    load_discharge_data, 
    load_inference_data,
    load_precip_observation_data, 
    load_precip_hourly_observation_data,
...
def get_forecast():
    ...
    df_precip_hourly_obs = load_precip_hourly_observation_data()
    ...
    return {
        ...
        "precip_hourly_obs": df_precip_hourly_obs.reset_index().to_dict(orient="records"),
